...
(5, 'expert');
--
-- Indexes for table `experiance_master`
--
...
CREATE TABLE `user_master` (
  ...
  `experience` varchar(15) DEFAULT NULL, -- Experiance for Trainer(In Years)
  `experience_level` int DEFAULT NULL, -- Experiance for Trainee(From experiance_master)
  `address` varchar(150) DEFAULT NULL, 
  `city` varchar(30) DEFAULT NULL,
  `postalcode` varchar(15) DEFAULT NULL,
  `country` int DEFAULT NULL, -- From country_master
  `services` varchar(2000) DEFAULT NULL, -- From services_master
  ...
  `forgotpass_identity` VARCHAR(32) NOT NULL DEFAULT '',
  `status` enum('1','0') COLLATE utf8_unicode_ci NOT NULL DEFAULT '1',
  `created` datetime DEFAULT NULL,
  `modified` datetime DEFAULT NULL,
   PRIMARY KEY (user_id),
   FOREIGN KEY (experience_level) REFERENCES experience_master(level_id),
   FOREIGN KEY (country) REFERENCES country_master(country_id)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

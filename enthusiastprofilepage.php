<!--
Filename:       trainerprofilepage.php
...
?>    
 ...
 <?php
    ...
    if ($user->getUserType()!='e')
        header("Location: trainerprofilepage.php?id=". $_GET['id']);
    ...
    $bio =   $user->getBio();
    $experience = $user->getLevelOfExperience();
...
<html>
    <head>
        ...
        <title>Enthusiast Profile Page | Real Fit Pro</title>
